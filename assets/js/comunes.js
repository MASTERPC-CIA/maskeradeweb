...
function ejectSubmitFormsHtmlOutput(elem, outputelem){
    ...
    $(outputelem).html('<img alt="Espere..." src="'+main_path+'resources/css/img/loading2.gif'+'">Espere...');        
        var form = $(this).parents('form');
...
function edad_mes_anio(){

    var mes = document.getElementById('mes_nac').value;
    var anio = document.getElementById('anio_nac').value;
...
//		alert("usted tiene " + edad_anios + " años y " + edad_mes + " mes(es)");
		return (edad_anios + " años" + edad_mes + " mes(es)");
	}
    else
	{
		if (edad_mes < 0)
		{
                    return (edad_anios-1)+" años" +  ((12-mes)+mes_actual) + " mes(es)";
//			alert("usted tiene " + (edad_anios-1) + " años y " + ((12-mes)+mes_actual) + " mes(es)");
		}
		else
		{
                    return edad_anios + " años exactos";
