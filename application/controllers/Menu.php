...
class Menu extends CI_Controller
{
    ...
    public function get_productos_x_tipo()
    {
        ...
        if(isset($data->marca)){
            $or_where['UPPER(festiv1) like '] = '%'.strtoupper($data->marca).'%';
            $or_where['UPPER(festiv2) like '] = '%'.strtoupper($data->marca).'%';
            $or_where['UPPER(festiv3) like '] = '%'.strtoupper($data->marca).'%';
        }else{
            $or_where = null;
        }
        ...
        if($all_product_inicio){
            ...
            $all_product = $this->generic_model->get('billing_productos', $where_data, $fields, $order_by, $data->productosPerPage, $or_like_data = null, $and_like_data = null, $group_by = null, $or_where);
